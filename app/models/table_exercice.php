...
function addExerciseProceed () // proceeds the exercice addition in database
{
	$local_table = 'exercice';
	$local_data = [
			'nomexo' => strtoupper($_POST['nomexo']),
...
function updateExercise (int $idexercice, array $dataUpdate) // update exercise in the database (with exercise modification, on website)
{
    $local_table = 'exercice';
