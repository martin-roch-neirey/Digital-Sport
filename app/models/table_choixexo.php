...
function selectClientExerciseTraining ()
{
	...
	$local_whereParams = [['refmuscle','=',$_POST['refmuscle']],['reftypemuscu','=',$_POST['reftypemuscu']],['refniveau','=',$_SESSION['refniveau']],['refmateriel','=',$_POST['refmateriel']]];
