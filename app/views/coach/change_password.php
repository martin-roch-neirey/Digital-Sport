...
<main>
    ...
    <h3 class="message-display">
      ...
      <br><br><br>
  <body>
    <form id="RegisterUserForm" action='<?php echo get_url('coach','change_password_proceed') ?>' method="post">
        ...
        <table class="table-content">
            <thead>
                <tr>
                    <th colspan="2"><?php echo(($_SESSION['prenomcoach'])); echo(" ".($_SESSION['nomcoach'])) ?> </th>
                </tr>
            </thead>
            <tbody>
              <tr>
