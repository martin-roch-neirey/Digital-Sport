	...
	<div id="partie1" class="divpartie">
		<div>
			...
			<div id="textexp">
				...
				<p>Seul ou suivis par un Coach, faites des entrainements qui vous correspondent</p>
	...
	<div id="partie2" class="divpartie">
		<div>
			<div>
				...
				<h3>Des exercices faciles à réaliser chez sois</h3>
			</div>
			<div>
				<img src="images/icon2.png" alt="icon2"/>
				<h3>Un suivi par un coach compétent</h3>
			</div>
			<div>
		...
		<div id="corps">
			<div id="bandeau1">
				<img class="imageronde" src="images/work_home.jpg" alt="work_home"/>
				<h3>Vous pouvez choisir de réaliser des exercices chez vous, à votre rythme pour garder la forme. Vous avez la possibilité de sélectionner le muscle, le matériel et le type de musculation pour évoluer suivant vos envies. Ces entrainements sont uniques vous êtes votre propre entraineur !
					<br/><br/>
					<a href="#">Je pars m'entrainer !</a>
				</h3>
			</div>
			<div id="bandeau2">
				<img class="imageronde" src="images/work_room.jpg" alt="work_room"/>
				<h3>Vous pouvez opter pour un suivis par un coach en salle. Vous vous entrainerez en suivant ses directives durant la séance, ils sont des motivateurs exceptionnels et vous poussent à performer et à dépasser vos limites. Inscrivez vous en amont pour profiter de ces séances !
					<br/><br/>
	...
	<div id="partie3" class="divpartie">
	    <div>
	        ...
	        <div>🔰 Vous serez un membre officiel de DigitalSport, l'une des salles de sport les plus demandées en Europe.</div>
	    </div>
	    <div>
	    	<h3>L'abonnement START en détails :</h3>
	    	...
	    	<div>Obtenez-le pour <a href="#">7.99€ / mois</a> !</div>
	    </div>
	    <div>
	    	<h3>L'abonnement SPORT+ en détails :</h3>
